...
class TestCreateEndpoint(unittest.TestCase):
    def test_single_prompt(self):
        ...
        creator = lightonmuse.Create("orion-fr-v2")
        ...
        assert cost['orion-fr-v2@default']['total_tokens_generated'] == n_tokens, \
            f"`cost={cost['orion-fr-v2@default']['total_tokens_generated']}` despite {n_tokens} tokens requested."
    ...
    def test_multiple_prompts(self):
        ...
        assert cost['orion-fr-v2@default']['total_tokens_generated'] == n_tokens*len(sentence_list), \
            f"`cost={cost['orion-fr-v2@default']['total_tokens_generated']}` despite {n_tokens} tokens for " \
    ...
    def test_multiple_outputs(self):
        ...
        assert cost['orion-fr-v2@default']["total_tokens_generated"] == n_tokens * n_completions, \
            f"Cost={cost['orion-fr-v2@default']['total_tokens_generated']} despite asking for {n_tokens} " \
    ...
    def test_control(self):
        ...
        assert outputs[0]["completions"][0]["output_text"][-2:] == "et", f"Completion does not " \
                                                                         f"end with stopword"
        assert cost["orion-fr-v2@default"]["total_tokens_generated"] < n_tokens, f"Cost is higher than expected given " \
