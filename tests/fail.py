...
single_input_endpoints = [lightonmuse.Analyse, lightonmuse.Create, lightonmuse.Embed]
double_input_endpoints = [lightonmuse.Compare, lightonmuse.Select]
...
class TestCreateEndpoint(unittest.TestCase):
    def test_empty_string(self):
        for endpoint in single_input_endpoints:
            ...
            assert "Receive empty text" in str(exception), (
                f"Exception for endpoint "
    ...
    def test_prompt_too_long(self):
        ...
        for endpoint in single_input_endpoints:
            ...
            exception = cm.exception
            assert "The input is too long" in str(exception), (
                f"Exception for endpoint "
                f"{endpoint.__class__.__name__} "
